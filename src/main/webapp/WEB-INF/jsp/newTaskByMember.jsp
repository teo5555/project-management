				...
				<table>
					<tbody>
						<tr>
							...
							<td><form:input path="title" required="required" readonly="true"/></td>
						</tr>

						<tr>
							<td><label>Description:</label></td>
							<td><form:input path="description" required="required" readonly="true"/></td>
						</tr>
						...
						<tr>
							...
							<td><form:input type="date" path="deadline"
									pattern="yyyy-MM-dd" required="required" readonly="true"/></td>
						<tr>
							<td><label></label></td>
